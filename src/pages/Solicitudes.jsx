  ...
  return (
    <>
      <div className="container-fluid">
                  ...
                  <tr id={elemento.id}>
                    ...
                    <td>
                      <textarea
                        className="form-control"
                        onChange={(e) =>
                          handleCambiarDescripcion(e.target.value, elemento.id)
                        }
        ...
        <div className="row">
          <div className="col-7">
            <DownloadPDFButton setMostrarLista={setMostrarLista}></DownloadPDFButton>
          </div>
        </div>
            </>
            :
            ...
            <div className="row mt-5">
                <div className="col-7 mx-auto fs-1">
                    ...
                    <span className="ms-3">Descargó la solicitud de reposición</span>
                </div>
            </div>
            <div className="row mx-auto">
                <div className="col-7">
